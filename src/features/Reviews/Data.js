const Data = [
  {
    ...
    quote: "Amy was fantastic - from the trail to the day she was professional, friendly and happy to work around what we pictured. "
    + "By the time we got to the venue she was already set up and ready to go.  She was able to add in the flowers we wanted and they stayed in place the whole day! "
  },
  {
    name: "Kat",
    location: "Whittlebury Hall",
    image: "../images/reviews/2.jpg",
    quote: "Thank you so much to Amy for doing mine and my bridesmaids hair on my wedding day in December, fabulous experience from start to finish"
  },
  {
    name: "Laura",
    location: "Houchins Barn",
    image: "../images/reviews/3.jpg",
    quote: "Amy did my wedding hair, flower girls and 2 bridesmaids.  Throughout the day I had so many people commenting how lovely my hair was"
  },
  {
    name: "Kelly",
    location: "Maison Talbooth",
    image: "../images/reviews/4.jpg",
    quote: "I got married in October and hadn't had the chance to thank you for mine and my bridesmaids stunning hair styles.  On the day arrival was prompt and just got on with it (which is just what you want on the morning of your big day). "
    + " In total I had 6 bridesmaids all wanting different looks but still in keeping with the style.  As for my hair Amy absolutely smashed it.  She achieved everything wanted (if not more) the whole process from trails to colour was spot on I can not thank you enough"
  },
  {
    name: "Hannah",
  ...
  },
  {
    ...
    quote: "Thank you so much for the beautiful hairstyles.  We all loved them.  Thank you for being part of my daughters day"
  },
  {
    name: "Holly",
    location: "The Fennes",
